...
const SHOTS: readonly HeroShot[] = [
  {
    ...
    alt: { kor: "합주 중에 서로를 바라보며 웃는 앙상블 메이 단원들", eng: "Ensemble M.A.Y members smiling at one another during rehearsal" },
    pos: "50% 32%",
    width: 1918,
    height: 1079,
  },
  {
    ...
    alt: { kor: "제1회 정기연주회를 마치고 무대에 나란히 선 앙상블 메이 단원들", eng: "Ensemble M.A.Y members lined up on stage after the 1st Annual Concert" },
    pos: "50% 62%",
    width: 1278,
    height: 853,
  },
  {
    ...
    alt: { kor: "악기를 들고 모여 앉은 앙상블 메이 단원들", eng: "Ensemble M.A.Y members seated together with their instruments" },
    pos: "50% 40%",
    band: true,
    light: true,
    width: 2829,
  ...
  },
  {
    ...
    alt: { kor: "피아노를 연주하는 앙상블 메이 단원", eng: "An Ensemble M.A.Y member playing the piano" },
    pos: "50% 24%",
    width: 1920,
    height: 1280,
  },
  {
    ...
    alt: { kor: "첼로를 연주하는 앙상블 메이 단원", eng: "An Ensemble M.A.Y member playing the cello" },
    pos: "50% 32%",
    width: 1920,
    height: 1281,
  },
  {
    ...
    alt: { kor: "무대 의상을 입고 첼로를 연주하는 앙상블 메이 단원", eng: "An Ensemble M.A.Y member playing the cello in concert dress" },
    pos: "50% 30%",
    width: 1920,
    height: 1281,
  },
