      ...
      <section className="sec sec--first">
        <div className="wrap">
          <div className="doc">
            ...
            {/* 글꼴은 예전에 Google Fonts·jsDelivr 에서 받아 썼지만, 지금은
                우리 쪽에 함께 두고 내보냅니다. 실제로 나가지 않는 곳을
                적어 두면 사실과 다른 고지가 됩니다. */}
            <p>
              글꼴을 비롯해 화면에 필요한 파일은 모두 이 사이트에서 직접 내보냅니다. 바깥으로 나가는
              것은 아래 하나뿐이고, 이 과정에서 방문자의 IP 주소와 브라우저 정보가 해당 서비스에
              전달됩니다. 앙상블 메이는 그 기록을 받아보지 않습니다.
            </p>
            <ul>
              <li>
