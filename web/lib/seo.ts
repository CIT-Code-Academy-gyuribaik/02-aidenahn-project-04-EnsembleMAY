...
/* 검색·공유에 쓰이는 정보 예전 HTML 6장의 <head> 에 흩어져 있던 것을 한 곳에 모았습니다. */
...
export const baseMetadata: Metadata = {
  ...
  openGraph: {
    ...
    url: SITE_URL,
    /* 카카오톡·슬랙·페이스북에 링크를 붙였을 때 뜨는 그림. 1200×630 은 어느 서비스나 자르지 않고 그대로 쓰는 크기입니다. metadataBase 가
       위에 있어서 "/og.png" 한 줄이면 절대 주소로 펴집니다 — 공유 그림은 상대 경로로 두면 대부분의 서비스가 못 받아 갑니다.
       ★ 아래 pageMeta() 가 이 openGraph 를 통째로 펼쳐 쓰므로, 여기 한 번 적으면 모든 페이지가 같은 그림을 씁니다. */
    images: [{ url: "/og.png", width: 1200, height: 630, alt: SITE_NAME }],
  },
  /* X(트위터)도 og:image 를 읽기는 하지만, 카드 종류를 따로 말해 주지 않으면 그림을 글 옆 작은 네모로 붙입니다. */
  twitter: {
